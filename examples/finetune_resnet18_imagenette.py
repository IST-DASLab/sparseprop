...
parser.add_argument('-e','--epochs', help='the number of epoch to train.', type=int, default=1)
parser.add_argument('-sf','--save-frequency', help='how often to save the model (in epochs).', type=int, default=1)
